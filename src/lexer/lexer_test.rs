...
fn TestLexerExample1() {
	let input = String::from("setAttr ($tforms[0] + \".translateZ\") (-1.0 * $val);");
	...
	let tests = vec!([
		testCheck{token::TypeMap.ProcIdent, "setAttr"},
		testCheck{token::TypeMap.Lparen, "("},
		testCheck{token::TypeMap.Ident, "$tforms"},
		testCheck{token::TypeMap.Lbracket, "["},
		testCheck{token::TypeMap.Int, "0"},
		testCheck{token::TypeMap.Rbracket, "]"},
		testCheck{token::TypeMap.Plus, "+"},
		testCheck{token::TypeMap.String, "\".translateZ\""},
		testCheck{token::TypeMap.Rparen, ")"},
		testCheck{token::TypeMap.Lparen, "("},
		testCheck{token::TypeMap.Minus, "-"},
		testCheck{token::TypeMap.Float, "1.0"},
		testCheck{token::TypeMap.Asterisk, "*"},
		testCheck{token::TypeMap.Ident, "$val"},
		testCheck{token::TypeMap.Rparen, ")"},
		testCheck{token::TypeMap.Semicolon, ";"},
		]);
